<?php
    ...
    */
    ...
    $backendHeader = "backend/header.php";

    $backendMenu   = "backend/menu.php";

    $backendFooter = "backend/footer.php";

    /* Frontend */

    $frontendHeader = "frontend/header.php";

    $frontendMenu   = "frontend/menu.php";

    $frontendFooter = "frontend/footer.php";
